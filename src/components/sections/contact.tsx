...
export default function ContactSection() {
  return (
    <section id="contact" className="py-16 md:py-24 flex items-center justify-center min-h-screen">
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-4xl mx-auto p-2 border-2 border-accent/30 rounded-lg bg-card/80 backdrop-blur-sm box-glow-accent">
