  ...
  return (
    <div className="absolute inset-0 z-0 overflow-hidden bg-background">
      ...
      <div className="absolute bottom-0 left-0 w-full h-3/4">
        <div className="w-[200%] h-full flex animate-pan-slow">
          <div style={{ ...cityLayerStyle, backgroundImage: `url("${buildings1}")` }} className="w-1/2 h-full"></div>
          <div style={{ ...cityLayerStyle, backgroundImage: `url("${buildings1}")` }} className="w-1/2 h-full"></div>
        </div>
      </div>
