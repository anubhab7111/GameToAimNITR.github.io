...
export default function HeroBackground() {
  ...
  return (
    <div className="absolute inset-0 z-0 overflow-hidden bg-background">
      ...
      {/* City Layers */}
      <div
        className="absolute bottom-0 left-0 w-[200%] h-3/4 animate-scroll-slow"
        style={{ backgroundImage: `url("${buildings1}")`, backgroundRepeat: 'repeat-x', backgroundSize: '50% 100%' }}
      ></div>
      <div
